...
```{r responsestyle26}
mod.yaysaying = glmmTMB(yaysaying~format + (1|proid), 
                  data = item_block1, family = "binomial")
tidy(aov(mod.yaysaying))
```

```{r responsestyle27, echo = F}
fb3_aov = tidy(aov(mod.yaysaying))
...
plot_yay = plot_b3$format +
  labs(title = "Likelihood of yay-saying",
       x = NULL, 
       y = NULL) +
  theme_pubclean() +
