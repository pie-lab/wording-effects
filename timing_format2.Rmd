---
title: "Impact on timing (Blocks 1 and 2)"
...
timing_block12 = data %>%
  select(proid, all_of(timing_block12), memory)
```
...
```{r}
timing_block12$format = as.factor(timing_block12$format)
timing_block12$format = relevel(timing_block12$format, ref = "a") 
timing_block12$format = factor(timing_block12$format,
                               levels = c("a","b","c","d"),
