...
```{r test-retest-11, results = 'hide'}
tr_mod3_b1b2 = lmer(block_2 ~ block_1*delayed_memory + 
                      (1 |proid),
                    data = items_matchb1)
tr_mod3_b1b3 = lmer(block_3 ~ block_1*very_delayed_memory + 
                      (1 |proid),
                    data = items_matchb1)
...
```{r test-retest-17, fig.cap = "Test-retest correlations of specific items across word format. Each dot represents the test-retest correlation within a specific item."}
items_cors %>%
