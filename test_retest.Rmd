...
output_type = ifelse(is_pdf, "latex", "html")
class(tr_mod1_b1b2) <- class(tr_mod1_b1b3) <- "lmerMod"
stargazer(tr_mod1_b1b2, tr_mod1_b1b3, 
          type = output_type, 
          intercept.top = T, 
          intercept.bottom = F, 
          digits = 2,
          title = "Test-retest reliability (items pooled) across time")
```
...
```{r, results = 'asis', echo = F}
class(tr_mod2_b1b2) <- class(tr_mod2_b1b3) <- "lmerMod"
stargazer(tr_mod2_b1b2, tr_mod2_b1b3, 
          type = output_type, 
          intercept.top = T, 
          intercept.bottom = F,
          digits = 2,
          title = "Test-retest reliability (items pooled) across time and moderated by participant memory")
```
