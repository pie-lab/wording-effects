...
pred.timing = predictions(mod.timing, 
                            by = "devicetype", 
                            type = "response")
...
effectsize::hedges_g(
  timing ~ devicetype, 
  data = filter(items_block1, devicetype %in% c("Tablet", "Mobile"))
)

effectsize::hedges_g(
  timing ~ devicetype, 
  data = filter(items_block1, devicetype %in% c("Tablet", "Computer"))
)

effectsize::hedges_g(
  timing ~ devicetype, 
  data = filter(items_block1, devicetype %in% c("Computer", "Mobile"))
  )
```
...
pred.responseD = predictions(mod.responseD, 
                            by = "devicetype", 
                            type = "response")
