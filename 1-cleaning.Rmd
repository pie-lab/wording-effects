...
First we count how many answers each participant responded to. Why count using code and not just looking at qualtrics? Two reasons: 
  1. It's not entirely clear from Qualtrics how many questions are in the survey, because there are 4 versions of each trait item and 4 different recall conditoins. 
