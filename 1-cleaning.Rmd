...
```{r 1-cleaning-66b, fig.cap = "Distribution of delayed memory scores"}
data %>%
...
```{r 1-cleaning-67b, fig.cap = "Relationship between immediate and delayed recall"}
data %>%
...
for(i in 1:length(original_id)){
  ...
  items_df$proid[data$proid == original_id[i]] = new_id[i]
}
```
