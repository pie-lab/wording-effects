...
adjective_timing = function(adjective){
  ...
  table = comp %>%
    ...
    kable(booktabs = T,
          digits = 2,
          caption = paste("Differences in log-seconds to", str_to_sentence(adjective), "by format (blocks 1 and 2)"),
          col.names = c("Contrast", "Difference in means", "SE", "z", "p", "low", "high")) %>%
    kable_styling() %>% 
