...
```{r, results = 'asis'}
responsible_model_mem = items_df %>%
...
```{r, results = 'asis'}
imaginative_model_mem = items_df %>%
...
```{r, results = 'asis'}
sophisticated_model_mem = items_df %>%
